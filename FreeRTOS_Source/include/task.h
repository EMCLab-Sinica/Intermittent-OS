 ...
 */
    ...
    BaseType_t xTaskCreate( TaskFunction_t pxTaskCode,
                            ...
                            int taskID,
                            int location) PRIVILEGED_FUNCTION; /*lint !e971 Unqualified char types are allowed for strings and single characters only. */
...
#if(configSUPPORT_LENGHTY_TASK == 1)
	 BaseType_t xAddTask(void* oldTCB) PRIVILEGED_FUNCTION;
#endif
